...
$dummy_restaurants_menus = [
    ...
    3 => [
        'name' => 'Hoppers House',
        'menu' => [
            ['id' => 301, 'name' => 'Plain Hoppers', 'description' => 'Crispy, bowl-shaped pancakes made from fermented rice flour.', 'price' => 200.00, 'image_url' => '../assets/images/food/plain-hoppers.jpg'],
            ['id' => 302, 'name' => 'Egg Hopper', 'description' => 'A plain hopper with a fried egg cooked into the center.', 'price' => 250.00, 'image_url' => '../assets/images/food/egg-hopper.jpg'],
            ['id' => 303, 'name' => 'String Hoppers', 'description' => 'Steamed rice flour noodles served with curry.', 'price' => 300.00, 'image_url' => '../assets/images/food/string-hoppers.jpg'],
            ['id' => 304, 'name' => 'Seafood String Hopper Biryani', 'description' => 'Layered with spiced rice, seafood, and vegetables.', 'price' => 850.00, 'image_url' => '../assets/images/food/seafood-hopper-biryani.jpg'],
            ['id' => 305, 'name' => 'Milk Hopper with Treacle', 'description' => 'A sweet, soft hopper served with kithul treacle.', 'price' => 350.00, 'image_url' => '../assets/images/food/milk-hopper.jpg']
        ]
    ],
    4 => [
        'name' => 'Pizza Hut',
        'menu' => [
            ['id' => 401, 'name' => 'Chicken Dominator Pizza', 'description' => 'Loaded with spicy chicken, onions, and capsicum.', 'price' => 1800.00, 'image_url' => '../assets/images/food/pizza-dominator.jpg'],
            ['id' => 402, 'name' => 'Garlic Bread', 'description' => 'Toasted bread with garlic butter and herbs.', 'price' => 400.00, 'image_url' => '../assets/images/food/garlic-bread.jpg'],
            ['id' => 403, 'name' => 'Veggie Supreme Pizza', 'description' => 'Mushrooms, onions, peppers, and olives on a classic crust.', 'price' => 1650.00, 'image_url' => '../assets/images/food/veggie-supreme.jpg'],
            ['id' => 404, 'name' => 'Spaghetti Bolognese', 'description' => 'Pasta with a rich meat and tomato sauce.', 'price' => 950.00, 'image_url' => '../assets/images/food/spaghetti.jpg']
        ]
    ],
    5 => [
        'name' => 'Burger King',
        'menu' => [
            ['id' => 501, 'name' => 'Whopper', 'description' => 'Flame-grilled beef patty with fresh vegetables.', 'price' => 1100.00, 'image_url' => '../assets/images/food/whopper.jpg'],
            ['id' => 502, 'name' => 'Chicken Royale', 'description' => 'Crispy chicken fillet with lettuce and mayo.', 'price' => 950.00, 'image_url' => '../assets/images/food/chicken-royale.jpg'],
            ['id' => 503, 'name' => 'King Fries', 'description' => 'Crispy, golden French fries, perfectly salted.', 'price' => 350.00, 'image_url' => '../assets/images/food/king-fries.jpg'],
            ['id' => 504, 'name' => 'Onion Rings', 'description' => 'Crispy fried onion rings with a side of dipping sauce.', 'price' => 450.00, 'image_url' => '../assets/images/food/onion-rings.jpg']
        ]
        ],
    6 => [
        'name' => 'Sushi Palace',
        'menu' => [
            ['id' => 601, 'name' => 'California Roll', 'description' => 'Crab meat, avocado, and cucumber.', 'price' => 750.00, 'image_url' => '../assets/images/food/california-roll.jpg'],
            ['id' => 602, 'name' => 'Spicy Tuna Roll', 'description' => 'Fresh tuna mixed with spicy sauce.', 'price' => 850.00, 'image_url' => '../assets/images/food/spicy-tuna-roll.jpg'],
            ['id' => 603, 'name' => 'Salmon Sashimi', 'description' => 'Thinly sliced fresh raw salmon.', 'price' => 1200.00, 'image_url' => '../assets/images/food/salmon-sashimi.jpg'],
            ['id' => 604, 'name' => 'Dragon Roll', 'description' => 'Eel and cucumber topped with avocado.', 'price' => 1350.00, 'image_url' => '../assets/images/food/dragon-roll.jpg'],
            ['id' => 605, 'name' => 'Edamame', 'description' => 'Steamed soybeans with sea salt.', 'price' => 400.00, 'image_url' => '../assets/images/food/edamame.jpg']
        ]
    ]
